                ...
                <table>
                    ...
                    <tbody>
                        <tr v-for="item in cartStore.cartList" :key="item.id">
                            <td>
                                <!-- 单选框 -->
                                <el-checkbox :model-value="item.selected" @change="(selected: any) => singleCheck(item, selected)" />
                            </td> 
                            <td>
                                <div class="goods">
                            ...
                            <td class="tc"><el-input-number :min="1" :max="99" v-model="item.count" /></td>
...
// 单选回调
const singleCheck = (item: any, selected: boolean) => {
